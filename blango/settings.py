...
class Dev(Configuration):
    ...
    # ALLOWED_HOSTS = [] ## Original code

    #[CUSTOM] codio code block
    # ALLOWED_HOSTS = ['*'] # switching to class - see below
    ...
    INSTALLED_APPS = [
        ...
        "drf_yasg", # swagger
        'django_filters', #django filters (API)

        'versatileimagefield', # Images 
    ...
    #     'django.middleware.csrf.CsrfViewMiddleware', # CODIO only
        'django.contrib.auth.middleware.AuthenticationMiddleware',
        'django.contrib.messages.middleware.MessageMiddleware',
    #     'django.middleware.clickjacking.XFrameOptionsMiddleware', # CODIO only
    ]
